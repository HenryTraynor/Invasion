...
plot = plot + geom_line(data=inc_list[[1]], aes(x=time, y=invader, color="Increasing Invader CA")) + geom_line(data=const_high_list[[1]], aes(x=time, y=invader, color="Constant Invader CA")) + geom_line(data=const_low_list[[1]], aes(x=time, y=invader, color="Invader Failure"))+ scale_color_manual(name="Realization Types", values=c("Increasing Invader CA"="red", "Invader Failure"="blue", "Constant Invader CA"="#00BA38")) + xlab("Time (years)") + ylab("Invader Abundance")
