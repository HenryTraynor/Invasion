...
plot = plot + geom_line(data=inc_list[[1]], aes(x=time, y=invader, color="Increasing")) + geom_line(data=const_high_list[[1]], aes(x=time, y=invader, color="Constant1")) + geom_line(data=const_low_list[[1]], aes(x=time, y=invader, color="Constant2"))+ scale_color_manual(name="Realization Types", values=c("Increasing"="red", "Constant2"="blue", "Constant1"="#00BA38")) + xlab("Time (years)") + ylab("Invader Abundance")
...
plot.with.inset <- ggdraw() + draw_plot(plot) + draw_plot(plot.inset, x=0.07, y=0.7, width=0.3, height=0.3)
```
